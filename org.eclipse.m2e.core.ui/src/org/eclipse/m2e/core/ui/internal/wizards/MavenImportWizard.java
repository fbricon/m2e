...
public class MavenImportWizard extends AbstractMavenProjectWizard implements IImportWizard {
  ...
  /**
   * @deprecated mappingConfiguration is ignored. Use {@link #MavenImportWizard(ProjectImportConfiguration, List)}
   *             instead.
   */
  @Deprecated
  public MavenImportWizard(ProjectImportConfiguration configuration, List<String> collectedLocations,
      org.eclipse.m2e.core.internal.lifecyclemapping.discovery.LifecycleMappingConfiguration mappingConfiguration) {
    this(configuration, collectedLocations);
  }
